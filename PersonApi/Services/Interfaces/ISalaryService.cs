...
namespace PersonApi.Services.Interfaces
{
    ...
    {
        Task<List<InforSalary>> GetAllSalary();
        Task<InforSalary> GetSalaryById(int id);
        ...
        ///////
        Task<IPagedList<InforSalary>> GetSalaryPagedList(RequestParams requestParams);

        //  danh sách lương theo ngày tháng của toàn công ty
        Task<List<InforSalary>> GetSalaryByDate(DateTime date1, DateTime date2);
